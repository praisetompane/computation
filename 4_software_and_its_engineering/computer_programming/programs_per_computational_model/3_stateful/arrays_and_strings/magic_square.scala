...
def improve(y: Array[Array[Int]]) =
    ...
    for {
        ...
        if (rowSum != magicConstant) {
            ...
            val targetNumber1 = availableNumbers.filter(x =>
                x - y(r)(c) == differenceFromMagicConstant &&
                    x + y(r)(c + 1) + y(r)(c + 2) == magicConstant
            )

            val targetNumber2 = availableNumbers.filter(x =>
                x - y(r)(c + 1) == differenceFromMagicConstant &&
                    x + y(r)(c) + y(r)(c + 2) == magicConstant
            )

            val targetNumber3 = availableNumbers.filter(x =>
                x - y(r)(c + 2) == differenceFromMagicConstant &&
